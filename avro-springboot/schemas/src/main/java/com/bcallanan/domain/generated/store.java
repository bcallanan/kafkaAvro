...
public class store extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public com.bcallanan.domain.generated.Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(com.bcallanan.domain.generated.Address value) {
    this.address = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<store>
    ...
    private Builder(com.bcallanan.domain.generated.store.Builder other) {
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = com.bcallanan.domain.generated.Address.newBuilder(other.getAddressBuilder());
      }
    }
     ...
     * @return This builder.
     */
    public com.bcallanan.domain.generated.Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(com.bcallanan.domain.generated.Address.newBuilder(address));
        } else {
          setAddressBuilder(com.bcallanan.domain.generated.Address.newBuilder());
        }
      }
    ...
    public store build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[1] ? this.address : (com.bcallanan.domain.generated.Address) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
