...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5658952383638097530L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"com.bcallanan\",\"fields\":[{\"name\":\"greeting\",\"type\":\"string\"}]}");
   ...
   */
  public static com.bcallanan.Greeting.Builder newBuilder() {
    return new com.bcallanan.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static com.bcallanan.Greeting.Builder newBuilder(com.bcallanan.Greeting.Builder other) {
    if (other == null) {
      return new com.bcallanan.Greeting.Builder();
    } else {
      return new com.bcallanan.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static com.bcallanan.Greeting.Builder newBuilder(com.bcallanan.Greeting other) {
    if (other == null) {
      return new com.bcallanan.Greeting.Builder();
    } else {
      return new com.bcallanan.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bcallanan.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bcallanan.Greeting other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bcallanan.Greeting.Builder setGreeting(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bcallanan.Greeting.Builder clearGreeting() {
      greeting = null;
